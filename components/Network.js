...
export const Network = () => (
  <Grid templateColumns={{ base: 'auto', md: 'repeat(2, 1fr)' }} gap={5}>
    <ItemCard>
      ...
      <Image src="https://solana.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Findex_low_cost.5dfdb6d1.png&w=2048&q=90" alt="Low Cost" />
    </ItemCard>
    ...
    <ItemCard>
      ...
      <Image src="https://solana.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Findex_fast_fck.47b945e5.png&w=2048&q=90" alt="Fast Forever" />
    </ItemCard>
  </Grid>
)